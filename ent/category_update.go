...
func (cu *CategoryUpdate) SetCategoryId(s string) *CategoryUpdate {
	cu.mutation.SetCategoryId(s)
	return cu
}

// SetNillableCategoryId sets the "categoryId" field if the given value is not nil.
func (cu *CategoryUpdate) SetNillableCategoryId(s *string) *CategoryUpdate {
	if s != nil {
		cu.SetCategoryId(*s)
	}
	return cu
...
func (cu *CategoryUpdate) SetCategoryUrl(s string) *CategoryUpdate {
	cu.mutation.SetCategoryUrl(s)
	return cu
}

// SetNillableCategoryUrl sets the "categoryUrl" field if the given value is not nil.
func (cu *CategoryUpdate) SetNillableCategoryUrl(s *string) *CategoryUpdate {
	if s != nil {
		cu.SetCategoryUrl(*s)
	}
	return cu
...
func (cu *CategoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.CategoryUrl(); ok {
...
// SetCategoryId sets the "categoryId" field.
func (cuo *CategoryUpdateOne) SetCategoryId(s string) *CategoryUpdateOne {
	cuo.mutation.SetCategoryId(s)
	return cuo
}

// SetNillableCategoryId sets the "categoryId" field if the given value is not nil.
func (cuo *CategoryUpdateOne) SetNillableCategoryId(s *string) *CategoryUpdateOne {
	if s != nil {
		cuo.SetCategoryId(*s)
	}
	return cuo
...
// SetCategoryUrl sets the "categoryUrl" field.
func (cuo *CategoryUpdateOne) SetCategoryUrl(s string) *CategoryUpdateOne {
	cuo.mutation.SetCategoryUrl(s)
	return cuo
}

// SetNillableCategoryUrl sets the "categoryUrl" field if the given value is not nil.
func (cuo *CategoryUpdateOne) SetNillableCategoryUrl(s *string) *CategoryUpdateOne {
	if s != nil {
		cuo.SetCategoryUrl(*s)
	}
	return cuo
}
...
func (cuo *CategoryUpdateOne) sqlSave(ctx context.Context) (_node *Category, err error) {
	...
	if value, ok := cuo.mutation.CategoryUrl(); ok {
		_spec.SetField(category.FieldCategoryUrl, field.TypeString, value)
	}
